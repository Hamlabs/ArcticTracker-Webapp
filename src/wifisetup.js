/*
 Copyright (C) 2022 Øyvind Hanssen, LA7ECA, ohanssen@acm.org
                ...
                return m("div", [  
                    ...
                    m("form.aprs", [  
                        ...
                        m("div.field", 
                            ...
                            m(textInput, {passwd: true, value: t.data.appass, size: 15, maxLength:64,  onchange: dirty, regex: /^.*$/i })), br,
                
                        m("div.field", 
                            m("span.leftlab", "AP 1 (ssid,passwd): "),  
                            m(textInput, {value: t.data.ap_0_ssid, size: 15, maxLength:32,  onchange: dirty, regex: /^.*$/i }), 
                            m(textInput, {passwd: true, value: t.data.ap_0_pw, size: 15, maxLength:64, onchange: dirty, regex: /^.*$/i })), 
                        m("div.field", 
                            m("span.leftlab", "AP 2 (ssid,passwd): "),  
                            m(textInput, {value: t.data.ap_1_ssid, size: 15, maxLength:32,  onchange: dirty, regex: /^.*$/i }), 
                            m(textInput, {passwd: true, value: t.data.ap_1_pw, size: 15, maxLength:64,  onchange: dirty, regex: /^.*$/i })),  
                        m("div.field", 
                            m("span.leftlab", "AP 3 (ssid,passwd): "),  
                            m(textInput, {value: t.data.ap_2_ssid, size: 15, maxLength:32, onchange: dirty, regex: /^.*$/i }), 
                            m(textInput, {passwd: true, value: t.data.ap_2_pw, size: 15, maxLength:64, onchange: dirty, regex: /^.*$/i })), 
                        m("div.field", 
                            m("span.leftlab", "AP 4 (ssid,passwd): "),  
                            m(textInput, {value: t.data.ap_3_ssid, size: 15, maxLength:32, onchange: dirty, regex: /^.*$/i }), 
                            m(textInput, {passwd: true, value: t.data.ap_3_pw, size: 15, maxLength:64, onchange: dirty, regex: /^.*$/i })), 
                        m("div.field", 
                            m("span.leftlab", "AP 5 (ssid,passwd): "),  
                            m(textInput, {value: t.data.ap_4_ssid, size: 15, maxLength:32, onchange: dirty, regex: /^.*$/i }), 
                            m(textInput, {passwd: true, value: t.data.ap_4_pw, size: 15, maxLength:64, onchange: dirty, regex: /^.*$/i })), 
                        m("div.field", 
                            m("span.leftlab", "AP 6 (ssid,passwd): "),  
                            m(textInput, {value: t.data.ap_5_ssid, size: 15, maxLength:32, onchange: dirty, regex: /^.*$/i }), 
                            m(textInput, {passwd: true, value: t.data.ap_5_pw, size: 15, maxLength:64, onchange: dirty, regex: /^.*$/i })), br,
